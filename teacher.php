...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form action="tinsert.php" method="post" style="text-align:left;">
  <div class="form-group" >
    ID
    <input type="int" class="form-control" name="teacherid" placeholder="Example input">
    Name
    <input type="text" class="form-control" name="teachername" placeholder="Another input">
    Email
    <input type="text" class="form-control" name="teacheremail" placeholder="Another input">
    Designation
    <input type="text" class="form-control" name="teacherreg" placeholder="Example input">
    Address
    <input type="text" class="form-control" name="teacheraddress" placeholder="Another input">
    Mobile
    <input type="int" class="form-control" name="teachermobile" placeholder="Example input">
